...
class LightModeColors {
  static const lightPrimary = Color(0xFF1976D2); // Primary Blue
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE3F2FD);
  static const lightOnPrimaryContainer = Color(0xFF0D47A1);
  static const lightSecondary = Color(0xFF388E3C); // Success Green
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFF616161); // Neutral Gray
  ...
  static const lightWarning = Color(0xFFF57C00); // Warning Orange
...
class DarkModeColors {
  ...
  static const darkSecondary = Color(0xFF81C784); // Success Green
  static const darkOnSecondary = Color(0xFF1B5E20);
  static const darkTertiary = Color(0xFFBDBDBD); // Neutral Gray
  static const darkOnTertiary = Color(0xFF424242);
  static const darkError = Color(0xFFEF5350); // Emergency Red
  ...
  static const darkWarning = Color(0xFFFFB74D); // Warning Orange
  static const darkOnWarning = Color(0xFFE65100);
}
...
ThemeData get lightTheme => ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
      borderSide: BorderSide(color: LightModeColors.lightTertiary),
    ),
    enabledBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
      borderSide: BorderSide(color: LightModeColors.lightTertiary.withValues(alpha: 0.5)),
    ),
...
ThemeData get darkTheme => ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
      borderSide: BorderSide(color: DarkModeColors.darkTertiary),
    ),
    enabledBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
      borderSide: BorderSide(color: DarkModeColors.darkTertiary.withValues(alpha: 0.5)),
    ),
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
