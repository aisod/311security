...
import 'package:security_311_super_admin/services/auth_service.dart';
  ...
  Future<void> _loadUserProfile() async {
    ...
    try {
      ...
      if (profile != null) {
        ...
        AppLogger.info(
            'User profile loaded successfully: ${profile['full_name']}');
      } else {
        AppLogger.warning('No user profile found for ${_user!.id}');
        // Profile creation is handled in getCurrentUserProfile
        // If it still returns null, there was an error
        _userProfile = null;
      }
    } catch (e, stackTrace) {
