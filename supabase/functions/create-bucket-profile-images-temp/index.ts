...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Upload for profile-images" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'profile-images');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for profile-images" ON storage.objects FOR UPDATE USING (bucket_id = 'profile-images');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for profile-images" ON storage.objects FOR DELETE USING (bucket_id = 'profile-images');`
    ];
